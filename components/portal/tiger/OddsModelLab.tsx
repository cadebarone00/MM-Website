...
const inputClassName = "w-full rounded-lg border-2 border-gold-300 bg-white px-3 py-2 font-sans text-sm normal-case text-ink-900 outline-none focus:border-maroon-700";
