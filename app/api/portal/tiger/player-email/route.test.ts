...
test("POST /api/portal/tiger/player-email rejects when requireHost resolves null", async () => {
  ...
  const request = new Request("http://localhost/api/portal/tiger/player-email", {
    method: "POST",
