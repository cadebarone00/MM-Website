...
export default async function BroadcastPage({
  ...
  const mockRun = mock
    ...
    : null;
  const animationTest = preview && (params.animationTest === "birdie" || params.animationTest === "eagle" || params.animationTest === "bogey")
    ? {
        kind: params.animationTest as "birdie" | "eagle" | "bogey",
