...
export default async function MobileScoringPreview({ searchParams }: { searchParams: Promise<{ format?: string }> }) {
  ...
  return <>
    ...
    <main className="px-4 pb-8"><ScoringPanel playerSlug="cam-latto" playerFullName="Cam" round={1} matchBox={matchBox} nameBySlug={{ "cam-latto": "Cam", "pete-peabody": "Pete", "cade-barone": "Cade", "kyle-schnabel": "Kyle" }} previewState={state} /></main>
  </>;
}
