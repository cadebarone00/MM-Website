...
export default async function CareerStatsPage() {
  ...
  return (
    <div className="mx-auto max-w-[900px] px-4 py-12 sm:px-7">
      ...
      <div className="mt-6"><CareerStatsPanel records={[...careerArchiveRecords, ...liveRecords]} partnerships={careerArchivePartnerships} teamRecords={[...careerArchiveTeamRecords, ...liveTeamRecords]} /></div>
    </div>
  );
}
