    ...
    <main className="w-full pb-10">
      ...
      <section className="mx-auto mt-4 max-w-4xl px-3 sm:px-6">
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-5">
          ...
          <Link href={`/teams/stats/players/${playerSlug}`} className="group flex aspect-[4/3] flex-col justify-between rounded-xl border border-stone-300 bg-white p-4 shadow-sm transition hover:border-maroon-400 hover:shadow-md"><ChartNoAxesCombined size={22} className="text-maroon-700" aria-hidden="true" /><h2 className="font-serif text-lg font-bold text-ink-900">Career</h2></Link>
          <div className="flex aspect-[4/3] flex-col justify-between rounded-xl border border-stone-300 bg-white p-4 shadow-sm"><Video size={22} className="text-maroon-700" aria-hidden="true" /><h2 className="font-serif text-lg font-bold text-ink-900">Round video</h2></div>
