...
export default function HypeVideoPage() {
  return (
    <div className="mx-auto max-w-[960px] px-4 py-8 sm:px-7 sm:py-12">
      ...
      <video controls autoPlay playsInline className="mt-6 aspect-video w-full rounded-md bg-ink-900" src="https://pub-82adc1007d534ce9a1e5d7768bb26256.r2.dev/mm-edit-silver-springs-web.mp4" />
    </div>
  );
}
