  ...
  if (state.activeVideoQueueId) {
    ...
    if (data) {
      ...
      activeVideo = {
        ...
        shotNumber: data.shot_number, par: data.par, yards: data.yards, scoreToPar: data.score_to_par, individualPlace: placement >= 0 ? placementValueLabel(standings, placement) : null,
