...
flowchart TD
  ...
  X --> MP
  X --> PP
  %% Probability graphs label holes 1-18; the slider uses completed-hole boundaries between labels on desktop and mobile.
