...
flowchart TD
  ...
  X --> MP
  X --> PP
  %% Match profiles show a placeholder sportsbook board between the scorecard and Win Probability; no market prices are calculated.
