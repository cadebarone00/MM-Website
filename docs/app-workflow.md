...
flowchart TD
  ...
  X --> MP
  X --> PP
  %% Probability graphs label completed-hole slider positions, with gold axis ticks and decided results carried through hole 18.
